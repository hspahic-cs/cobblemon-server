...
dependencies {
    ...
    // Gson is provided by Minecraft at runtime but isn't on the plain-JUnit classpath; the store
    // tests need it directly. Matches the version MC 1.21.1 bundles.
