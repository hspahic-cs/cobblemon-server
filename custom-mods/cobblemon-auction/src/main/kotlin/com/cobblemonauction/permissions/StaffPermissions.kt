package com.cobblemonauction.permissions
 ...
 * it (same convention as [com.cobblemonauction.economy.EconomyBridge]) to keep the mods
...
object StaffPermissions {
    ...
    private val log = LoggerFactory.getLogger("cobblemon-auction/staff-perms")
