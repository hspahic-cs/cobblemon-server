package com.cobblemonbridge.permissions
 ...
 * it (same convention as [com.cobblemonbridge.economy.EconomyBridge]) to keep the mods
...
object StaffPermissions {
    ...
    private val log = LoggerFactory.getLogger("cobblemon-bridge/staff-perms")
