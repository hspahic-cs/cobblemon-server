...
object TowerManager {
    ...
    val POOL: List<Pair<String, String>> = listOf(
        "gym_01_clay_challenge" to "Clay",
        "gym_02_gardenia_challenge" to "Gardenia",
        "gym_03_korrina_challenge" to "Korrina",
        "gym_04_byron_challenge" to "Byron",
        "gym_05_blaine_challenge" to "Blaine",
        "gym_06_volkner_challenge" to "Volkner",
        "gym_07_crasher_wake_challenge" to "Crasher Wake",
        "gym_08_sabrina_challenge" to "Sabrina",
        "gym_09_drayden_challenge" to "Drayden",
        "gym_10_morty_challenge" to "Morty",
        "gym_11_viola_challenge" to "Viola",
        "gym_12_cheren_challenge" to "Cheren",
        "gym_13_lt_surge_challenge" to "Lt. Surge",
        "gym_14_grant_challenge" to "Grant",
        "gym_15_skyla_challenge" to "Skyla",
        "gym_16_brycen_challenge" to "Brycen",
        "gym_17_valerie_challenge" to "Valerie",
        "gym_18_marnie_challenge" to "Marnie",
    )
