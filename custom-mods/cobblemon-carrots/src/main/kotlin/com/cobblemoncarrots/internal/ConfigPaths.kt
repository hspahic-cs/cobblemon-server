package com.cobblemoncarrots.internal
...
/**
 * Resolves authored/runtime paths under `config/cobblemon-carrots/` and
 * migrates legacy flat-layout files on first boot.
 *
 * See docs/design/mod-state-vs-config.md.
 *
 *   config/cobblemon-carrots/authored/<name>   ← design data, ships from repo
 *   config/cobblemon-carrots/runtime/<name>    ← per-instance state
 */
internal object ConfigPaths {
    private const val MOD_ID = "cobblemon-carrots"
