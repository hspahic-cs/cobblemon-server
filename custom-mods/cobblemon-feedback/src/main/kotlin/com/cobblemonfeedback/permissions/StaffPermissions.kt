package com.cobblemonfeedback.permissions
 ...
 * it (same convention as the per-mod NeoEssentials economy bridges) to keep the mods
...
object StaffPermissions {
    ...
    private val log = LoggerFactory.getLogger("cobblemon-feedback/staff-perms")
