package com.cobblemongacha.internal
...
/**
 * Resolves authored/runtime paths under `config/cobblemon-gacha/` and
 * migrates legacy flat-layout files on first boot.
 *
 * See docs/design/mod-state-vs-config.md.
 *
 *   config/cobblemon-gacha/authored/<name>   ← design data, ships from repo
 *   config/cobblemon-gacha/runtime/<name>    ← per-instance state
 */
internal object ConfigPaths {
    private const val MOD_ID = "cobblemon-gacha"
