...
public record BridgeServices(BridgeConfig config, LinkStore links, PokerogueDb db, RunTracker tracker,
                             MilestoneEngine milestones, DbPoller poller, MinecraftServer server) {}
