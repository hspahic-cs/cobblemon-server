...
??? note "Common crate: 21 possible rewards"
    ...
    | Chance | Reward |
    |---:|---|
    | 18.0% | Common Pokémon Egg |
    | 9.0% | 1 Exp Candy M |
    | 7.0% | 5 EV Vitamin (random) |
    | 7.0% | 1 Evolution Stone (random) |
    | 7.0% | Uncommon Pokémon Egg |
    | 6.0% | Type-Boost Held Item (random) |
    | 6.0% | Evolution Item (random) |
    | 5.0% | 1 Rare Candy |
    | 4.0% | 40 Poké Balls |
    | 4.0% | 20 Great Balls |
    | 4.0% | 3 Revives |
