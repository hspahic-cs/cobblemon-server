...
Every quest available on the server, grouped by chain.

## Mainline

| # | Quest | Condition | Reward |
|---:|---|---|---|
| 1 | **Pick a Starter** | Select your first Pokémon from the starter list. | 10 Poké Balls |
| 2 | **Into the Wild** | Venture into the wilderness with /wild. | 3 Raw Copper + 5 Bone Meal |
| 3 | **A Place to Crash** | Set a home with /sethome <name>. | 3 Red Apricorn Sprouts |
| 4 | **Catch ’em** | Craft a Poké Ball. | 5 Great Balls |
| 5 | **Gotta Catch One** | Capture a wild Pokémon. | 3 Carrots |
| 6 | **Green Thumb** | Stockpile 32 carrots. | 3 Blue Apricorn Sprouts |
...
| # | Quest | Condition | Reward |
|---:|---|---|---|
| 1 | **Climbing** | Reach 1100 ELO in Ranked. | Great Ball + Super Potio |
| 2 | **Contender** | Reach 1200 ELO in Ranked. | Ultra Ball + Hyper Potio |
| 3 | **Veteran** | Reach 1300 ELO in Ranked. | 1 Rare Candy |
| 4 | **Top Cut** | Reach 1500 ELO in Ranked. | 1 Master Ball |
| 5 | **Master** | Reach 2000 ELO in Ranked. | Ultra Key |

## Pokédex milestones (optional)
