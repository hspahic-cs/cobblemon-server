...
execute at @s positioned ^0 ^ ^ run tag @e[type=rctmod:trainer,distance=..5,limit=1,sort=nearest,nbt={TrainerId:"aitest_gym_05_blaine_t0_pe"}] add cobblemon_bridge.level_cap.50
...
execute at @s positioned ^3 ^ ^ run tag @e[type=rctmod:trainer,distance=..5,limit=1,sort=nearest,nbt={TrainerId:"aitest_gym_05_blaine_t1_pe"}] add cobblemon_bridge.level_cap.50
...
execute at @s positioned ^6 ^ ^ run tag @e[type=rctmod:trainer,distance=..5,limit=1,sort=nearest,nbt={TrainerId:"aitest_gym_05_blaine_t2_pe"}] add cobblemon_bridge.level_cap.50
...
execute at @s positioned ^9 ^ ^ run tag @e[type=rctmod:trainer,distance=..5,limit=1,sort=nearest,nbt={TrainerId:"aitest_gym_04_byron_t0_pe"}] add cobblemon_bridge.level_cap.50
...
execute at @s positioned ^12 ^ ^ run tag @e[type=rctmod:trainer,distance=..5,limit=1,sort=nearest,nbt={TrainerId:"aitest_gym_04_byron_t1_pe"}] add cobblemon_bridge.level_cap.50
...
execute at @s positioned ^15 ^ ^ run tag @e[type=rctmod:trainer,distance=..5,limit=1,sort=nearest,nbt={TrainerId:"aitest_gym_04_byron_t2_pe"}] add cobblemon_bridge.level_cap.50
