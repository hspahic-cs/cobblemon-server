# Flavor for beating Faker (shared by normal + hard). The Rare Key and the cash bounty are
...
tellraw @s [{"text":"\n§5§l[Secret] ","bold":true},{"text":"You bested Faker — the Unkillable Demon King.","color":"white","bold":true},{"text":"\n§6§l✦ Reward: §e§lRare Key","bold":false}]
