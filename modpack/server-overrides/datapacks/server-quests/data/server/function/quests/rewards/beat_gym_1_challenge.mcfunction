# Awarded by cobblemon-bridge GymDefeatHook for gym_id=1 challenge variant.
playsound minecraft:ui.toast.challenge_complete master @s ~ ~ ~ 1.0 0.9
tellraw @s [{"text":"\n§5§l[Challenge Defeated] ","bold":true},{"text":"Gym 1: Dusty — Challenge","color":"light_purple","bold":true},{"text":"\n§6§l✦ Reward: §e§lRare Key","bold":false},{"text":"\n"}]
